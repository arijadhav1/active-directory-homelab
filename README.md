...
To test it, I temporarily opened the Vultr RDP firewall rule to allow connections from anywhere, then RDP'd in from Kali Linux. The search immediately surfaced the event with a different source IP, confirming the detection logic worked.
